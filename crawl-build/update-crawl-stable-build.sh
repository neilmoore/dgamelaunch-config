...
VERS_RE='^[0-9]+.[0-9]+|nostalgia|frogs|hellcrawl-cbro|dpegs_dynamic_monsters|councilgod-PR|councilgod|adrenaline_rush|thorn_god|basajaun|salamander|faithful|evoker-god-rebase|orcs_and_elves|combo_god|abyssrun|evoker-god|imp|bearkin|squarelos-0.17|mulch_ado_about_nothing|no_backtracking_god$'
