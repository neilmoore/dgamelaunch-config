...
VERS_RE='^[0-9]+.[0-9]+|helen|farmer|potion_fun|webtiles-changes|bloaxcrawl|vaulted|dominoes|megavamps$'
...
#remove since we sometimes want to rebuild 
...
say-do crawl-do nice make -C source \
    ...
    NO_OPTIMIZE=YesPlease DEBUG=YesPlease \
    EXTERNAL_FLAGS_L="-g"
